...
//        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        Intent playIntent = new Intent(MainActivity1.this, MusicService.class);//实例化一个Intent对象
        //绑定服务
...
//                mediaPlayer.seekTo(currentPosition);
        ...
        //加载歌单列表
        initSongSheet();
        SongSheetAdapter songSheetAdapter = new SongSheetAdapter(MainActivity1.this, R.layout.my_list_song_item, songSheetDataList);
        ...
        songSheetList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(MainActivity1.this, SongSheetActivity.class);
        ...
        myRecordListBtn.setOnClickListener((view) -> {
            Log.i("info", "出来列表");
            showDialog(MainActivity1.this, R.layout.player_bottom_list_layout);
        });

        linearSetKSongBtn.setOnClickListener((view) -> {
            Log.i("info", "进入K歌列表（新歌榜单）");
            Intent intent = new Intent(MainActivity1.this, KSongListActivity.class);
            startActivity(intent);
        });
